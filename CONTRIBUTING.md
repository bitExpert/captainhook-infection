...
If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/captainhook-infection/issues).
...
```console
$ git clone git@github.com:bitExpert/captainhook-infection.git
$ cd captainhook-infection
```
...
2. Fork the repository (https://github.com/bitExpert/captainhook-infection)
...
```console
$ git remote add {username} git@github.com:{username}/captainhook-infection.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/captainhook-infection.git
